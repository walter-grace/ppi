    ...
    extend: {
      colors: {
        ...
        luxury: {
          ...
          "platinum-light": "hsl(var(--luxury-platinum-light))",
          "platinum-dark": "hsl(var(--luxury-platinum-dark))",
          dark: "hsl(var(--luxury-dark))",
          "dark-lighter": "hsl(var(--luxury-dark-lighter))",
          "dark-lightest": "hsl(var(--luxury-dark-lightest))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
